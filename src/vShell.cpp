...
/*
void vShell::logQueryResult(const QueryResult& res) {
    if (!res.success) {
...
*/
/*
vShell::vShell(IQueryProvider& provider) : m_provider(provider), m_running(true) {
        initializeHandlers();
    }
    */

vShell::vShell() : m_running(true) {
    initializeHandlers();
}
...
void vShell::initializeHandlers() {
    ...
    /*
    void vShell::handleIfCommand(const ShellCommand& sc) {
        if (sc.args.size() < 3) {
    ...
    */
    ...
    void vShell::handleInput(const std::wstring& line, std::wstring& accumulator) {
    ...
    */
void vShell::addToHistory(const std::wstring& query) {
...
std::wstring vShell::substituteVariables(std::wstring query, const std::map<std::wstring, std::wstring>& vars) {
    ...
    void vShell::processQuery(const std::wstring& query) {
        /*
    ...
    void vShell::handleLoadCommand(const ShellCommand& sc) {
        /*
             if (!sc.args.empty()) {
                 if (m_provider.loadState(sc.args[0])) LOG_SUCCESS(L"State loaded.");
                 else LOG_ERROR(L"Failed to load state.");
    ...
    */
    ...
    std::wstring vShell::normalizeVarName(std::wstring name) {
    ...
    void vShell::assignFromQuery(const std::wstring& varName, std::wstring subQuery) {
        /*
    ...
    void vShell::assignFromLastResult(const std::wstring& varName, const std::wstring& colName) {
        /*
    ...
    void vShell::displaySingleVariable(const std::wstring& varName) {
    ...
    void vShell::handleRequeryCommand(const ShellCommand& sc) {
    ...
    void vShell::handleEchoCommand(const ShellCommand& sc) {
    ...
    void vShell::handleImportCommand(const ShellCommand& sc) {
    ...
    void vShell::handleSaveCommand(const ShellCommand& sc) {
        /*
    ...
    void vShell::handleInfoCommand(const ShellCommand& sc) {
        /*
    ...
    void vShell::handleUnsetCommand(const ShellCommand& sc) {
    ...
    void vShell::handleClearCommand(const ShellCommand& sc) {
     
        ConsoleManager::getInstance().clear();
    }
    
    
    void vShell::handleHistoryCommand(const ShellCommand& sc) {
    ...
    void vShell::handleRunCommand(const ShellCommand& sc) {
    ...
    void vShell::handlePauseCommand(const ShellCommand& sc){
    ...
    /*
    void vShell::handleForeachCommand(const ShellCommand& sc) {
...
*/
    ...
    void vShell::handleDescribeCommand(const ShellCommand& sc) {
     /*
            if (!sc.args.empty()) {
                this->res = m_provider.describeTable(sc.args[0]);
                logQueryResult(this->res);
    ...
    */
    ...
    void vShell::handleSysCommand(const ShellCommand& sc) {
        if (sc.args.empty()) {
